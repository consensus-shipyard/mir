...
func (x *ReqWaitReference) Reset() {
	*x = ReqWaitReference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_isspbftpb_isspbftpb_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReqWaitReference) Descriptor() ([]byte, []int) {
	return file_isspbftpb_isspbftpb_proto_rawDescGZIP(), []int{11}
}
...
func (x *VCBatchTimeout) Reset() {
	*x = VCBatchTimeout{}
	if protoimpl.UnsafeEnabled {
		mi := &file_isspbftpb_isspbftpb_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VCBatchTimeout) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VCBatchTimeout) ProtoMessage() {}

func (x *VCBatchTimeout) ProtoReflect() protoreflect.Message {
	mi := &file_isspbftpb_isspbftpb_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VCBatchTimeout.ProtoReflect.Descriptor instead.
func (*VCBatchTimeout) Descriptor() ([]byte, []int) {
	return file_isspbftpb_isspbftpb_proto_rawDescGZIP(), []int{12}
}

func (x *VCBatchTimeout) GetView() uint64 {
	if x != nil {
		return x.View
	}
	return 0
...
func (x *VCBatchTimeout) GetNumCommitted() uint64 {
	if x != nil {
...
func (x *Status) Reset() {
	*x = Status{}
	if protoimpl.UnsafeEnabled {
		mi := &file_isspbftpb_isspbftpb_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return file_isspbftpb_isspbftpb_proto_rawDescGZIP(), []int{13}
}
...
var file_isspbftpb_isspbftpb_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x66, 0x74, 0x70, 0x62, 0x22, 0x67, 0x0a, 0x0a, 0x50, 0x72, 0x65, 0x70, 0x72, 0x65,
	0x70, 0x61, 0x72, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x73, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x02, 0x73, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x04, 0x76, 0x69, 0x65, 0x77, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x65, 0x72, 0x74,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x22,
	0x45, 0x0a, 0x07, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x73, 0x6e,
	...
	0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x44, 0x0a, 0x06, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	...
	,
	...
	,
	...
	0x04, 0x76, 0x69, 0x65, 0x77, 0x22, 0x48, 0x0a, 0x0e, 0x56, 0x43, 0x42, 0x61, 0x74, 0x63, 0x68,
	0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x76, 0x69, 0x65, 0x77, 0x12, 0x22, 0x0a, 0x0c, 0x6e,
	0x75, 0x6d, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x0c, 0x6e, 0x75, 0x6d, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x22,
...
var file_isspbftpb_isspbftpb_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_isspbftpb_isspbftpb_proto_goTypes = []interface{}{
	...
	(*Done)(nil),              // 3: isspbftpb.Done
	(*CatchUpRequest)(nil),    // 4: isspbftpb.CatchUpRequest
	(*ViewChange)(nil),        // 5: isspbftpb.ViewChange
	(*SignedViewChange)(nil),  // 6: isspbftpb.SignedViewChange
	(*NewView)(nil),           // 7: isspbftpb.NewView
	(*PSetEntry)(nil),         // 8: isspbftpb.PSetEntry
	(*QSetEntry)(nil),         // 9: isspbftpb.QSetEntry
	(*PreprepareRequest)(nil), // 10: isspbftpb.PreprepareRequest
	(*ReqWaitReference)(nil),  // 11: isspbftpb.ReqWaitReference
	(*VCBatchTimeout)(nil),    // 12: isspbftpb.VCBatchTimeout
	(*Status)(nil),            // 13: isspbftpb.Status
}
var file_isspbftpb_isspbftpb_proto_depIdxs = []int32{
	8, // 0: isspbftpb.ViewChange.p_set:type_name -> isspbftpb.PSetEntry
	9, // 1: isspbftpb.ViewChange.q_set:type_name -> isspbftpb.QSetEntry
	5, // 2: isspbftpb.SignedViewChange.view_change:type_name -> isspbftpb.ViewChange
	6, // 3: isspbftpb.NewView.signed_view_changes:type_name -> isspbftpb.SignedViewChange
	0, // 4: isspbftpb.NewView.preprepares:type_name -> isspbftpb.Preprepare
...
func file_isspbftpb_isspbftpb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_isspbftpb_isspbftpb_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_isspbftpb_isspbftpb_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VCBatchTimeout); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_isspbftpb_isspbftpb_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
