...
import (
	_ "github.com/filecoin-project/mir/pkg/pb/blockchainpb"
...
type Event_PayloadRequest struct {
	PayloadRequest *PayloadRequest `protobuf:"bytes,2,opt,name=payload_request,json=payloadRequest,proto3,oneof"`
}

type Event_PayloadResponse struct {
	PayloadResponse *PayloadResponse `protobuf:"bytes,3,opt,name=payload_response,json=payloadResponse,proto3,oneof"`
}
...
var file_blockchainpb_applicationpb_applicationpb_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe7, 0x01, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x77, 0x48, 0x65, 0x61, 0x64, 0x12, 0x48, 0x0a, 0x0f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	...
	,
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x42, 0x43, 0x5a, 0x41, 0x67,
...
var file_blockchainpb_applicationpb_applicationpb_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_blockchainpb_applicationpb_applicationpb_proto_goTypes = []interface{}{
	...
	(*PayloadRequest)(nil),    // 2: applicationpb.PayloadRequest
	(*PayloadResponse)(nil),   // 3: applicationpb.PayloadResponse
...
var file_blockchainpb_applicationpb_applicationpb_proto_depIdxs = []int32{
	...
	2, // 1: applicationpb.Event.payload_request:type_name -> applicationpb.PayloadRequest
	3, // 2: applicationpb.Event.payload_response:type_name -> applicationpb.PayloadResponse
	4, // 3: applicationpb.PayloadResponse.payload:type_name -> payloadpb.Payload
