...
import (
	...
	types "github.com/filecoin-project/mir/pkg/pb/checkpointpb/checkpointvaliditycheckerpb/types"
...
func UponEvent[W types.Event_TypeWrapper[Ev], Ev any](m dsl.Module, handler func(ev *Ev) error) {
	dsl.UponMirEvent[*types1.Event_Cvc](m, func(ev *types.Event) error {
		w, ok := ev.Type.(W)
		if !ok {
			return nil
		}
