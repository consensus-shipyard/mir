...
func UponPreprepareReceived(m dsl.Module, handler func(from types1.NodeID, sn uint64, view uint64, data []uint8, aborted bool) error) {
...
func UponPrepareReceived(m dsl.Module, handler func(from types1.NodeID, sn uint64, view uint64, digest []uint8) error) {
...
func UponCommitReceived(m dsl.Module, handler func(from types1.NodeID, sn uint64, view uint64, digest []uint8) error) {
...
func UponCatchUpRequestReceived(m dsl.Module, handler func(from types1.NodeID, digest []uint8, sn uint64) error) {
...
func UponPreprepareRequestReceived(m dsl.Module, handler func(from types1.NodeID, digest []uint8, sn uint64) error) {
...
func UponNewViewReceived(m dsl.Module, handler func(from types1.NodeID, view uint64, viewChangeSenders []string, signedViewChanges []*types.SignedViewChange, preprepareSeqNrs []uint64, preprepares []*types.Preprepare) error) {
