...
type Preprepare struct {
	...
	Signature []byte `protobuf:"bytes,5,opt,name=signature,proto3" json:"signature,omitempty"` //only used if orderers.common.AccountabilityMode != noAccountability
}
...
type Prepare struct {
	...
	Signature []byte `protobuf:"bytes,4,opt,name=signature,proto3" json:"signature,omitempty"` //only used if orderers.common.AccountabilityMode == AllAccountable
}
...
type Commit struct {
	...
	View       uint64      `protobuf:"varint,2,opt,name=view,proto3" json:"view,omitempty"`
	Digest     []byte      `protobuf:"bytes,3,opt,name=digest,proto3" json:"digest,omitempty"`
	Preprepare *Preprepare `protobuf:"bytes,4,opt,name=preprepare,proto3" json:"preprepare,omitempty"` //only used if orderers.common.AccountabilityMode != noAccountability
}
...
func (x *Commit) GetPreprepare() *Preprepare {
	if x != nil {
		return x.Preprepare
	}
	return nil
...
var file_pbftpb_pbftpb_proto_rawDesc = []byte{
	...
	0x04, 0xc8, 0xe4, 0x1d, 0x01, 0x22, 0xfe, 0x01, 0x0a, 0x0a, 0x50, 0x72, 0x65, 0x70, 0x72, 0x65,
	...
	0x3a, 0x04, 0xd0, 0xe4, 0x1d, 0x01, 0x22, 0xe5, 0x01, 0x0a, 0x07, 0x50, 0x72, 0x65, 0x70, 0x61,
	0x72, 0x65, 0x12, 0x4b, 0x0a, 0x02, 0x73, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x42, 0x3b,
	...
	0x51, 0x0a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x42, 0x3d, 0x82,
	...
	0x69, 0x72, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x65, 0x72, 0x73, 0x2f,
	0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x56, 0x69, 0x65, 0x77, 0x4e, 0x72, 0x52, 0x04, 0x76, 0x69,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x3a, 0x04, 0xd0, 0xe4, 0x1d, 0x01, 0x22, 0xfa,
	0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x4b, 0x0a, 0x02, 0x73, 0x6e, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x42, 0x3b, 0x82, 0xa6, 0x1d, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x72, 0x61, 0x6e, 0x74, 0x6f, 0x72, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x53, 0x65, 0x71,
	0x4e, 0x72, 0x52, 0x02, 0x73, 0x6e, 0x12, 0x51, 0x0a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x18, 0x02,
	...
	,
...
var file_pbftpb_pbftpb_proto_depIdxs = []int32{
	...
	1,  // 10: pbftpb.Commit.preprepare:type_name -> pbftpb.Preprepare
	1,  // 11: pbftpb.CatchUpResponse.resp:type_name -> pbftpb.Preprepare
	11, // 12: pbftpb.SignedViewChange.view_change:type_name -> pbftpb.ViewChange
	1,  // 13: pbftpb.MissingPreprepare.preprepare:type_name -> pbftpb.Preprepare
	7,  // 14: pbftpb.NewView.signed_view_changes:type_name -> pbftpb.SignedViewChange
	1,  // 15: pbftpb.NewView.preprepares:type_name -> pbftpb.Preprepare
	12, // 16: pbftpb.ViewChange.p_set:type_name -> pbftpb.PSetEntry
	13, // 17: pbftpb.ViewChange.q_set:type_name -> pbftpb.QSetEntry
	15, // 18: pbftpb.Event.propose_timeout:type_name -> pbftpb.ProposeTimeout
	16, // 19: pbftpb.Event.view_change_sn_timeout:type_name -> pbftpb.ViewChangeSNTimeout
	17, // 20: pbftpb.Event.view_change_seg_timeout:type_name -> pbftpb.ViewChangeSegTimeout
