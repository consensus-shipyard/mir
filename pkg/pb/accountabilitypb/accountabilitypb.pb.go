...
type FullCertificate struct {
	...
	Certificate map[uint64]*SignedPredecision `protobuf:"bytes,1,rep,name=certificate,proto3" json:"certificate,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *FullCertificate) GetCertificate() map[uint64]*SignedPredecision {
	if x != nil {
		return x.Certificate
	}
	return nil
