...
type Event struct {
	...
	//	*Event_SignResult
	//	*Event_VerifyNodeSig
	//	*Event_NodeSigVerified
	//	*Event_VerifyNodeSigBatch
	//	*Event_NodeSigBatchVerified
	//	*Event_RequestReady
	//	*Event_SendMessage
...
func (x *Event) GetVerifyNodeSig() *VerifyNodeSig {
	if x, ok := x.GetType().(*Event_VerifyNodeSig); ok {
		return x.VerifyNodeSig
	}
	return nil
}

func (x *Event) GetNodeSigVerified() *NodeSigVerified {
	if x, ok := x.GetType().(*Event_NodeSigVerified); ok {
		return x.NodeSigVerified
	}
	return nil
}

func (x *Event) GetVerifyNodeSigBatch() *VerifyNodeSigBatch {
	if x, ok := x.GetType().(*Event_VerifyNodeSigBatch); ok {
		return x.VerifyNodeSigBatch
	}
	return nil
}

func (x *Event) GetNodeSigBatchVerified() *NodeSigBatchVerified {
	if x, ok := x.GetType().(*Event_NodeSigBatchVerified); ok {
		return x.NodeSigBatchVerified
	}
	return nil
}
...
type Event_SignRequest struct {
	SignRequest *SignRequest `protobuf:"bytes,9,opt,name=sign_request,json=signRequest,proto3,oneof"`
}

type Event_SignResult struct {
	SignResult *SignResult `protobuf:"bytes,10,opt,name=sign_result,json=signResult,proto3,oneof"`
}

type Event_VerifyNodeSig struct {
	VerifyNodeSig *VerifyNodeSig `protobuf:"bytes,11,opt,name=verify_node_sig,json=verifyNodeSig,proto3,oneof"`
}

type Event_NodeSigVerified struct {
	NodeSigVerified *NodeSigVerified `protobuf:"bytes,12,opt,name=node_sig_verified,json=nodeSigVerified,proto3,oneof"`
}

type Event_VerifyNodeSigBatch struct {
	VerifyNodeSigBatch *VerifyNodeSigBatch `protobuf:"bytes,13,opt,name=verify_node_sig_batch,json=verifyNodeSigBatch,proto3,oneof"`
}

type Event_NodeSigBatchVerified struct {
	NodeSigBatchVerified *NodeSigBatchVerified `protobuf:"bytes,14,opt,name=node_sig_batch_verified,json=nodeSigBatchVerified,proto3,oneof"`
}

type Event_RequestReady struct {
	RequestReady *RequestReady `protobuf:"bytes,15,opt,name=request_ready,json=requestReady,proto3,oneof"`
}

type Event_SendMessage struct {
	SendMessage *SendMessage `protobuf:"bytes,16,opt,name=send_message,json=sendMessage,proto3,oneof"`
}

type Event_MessageReceived struct {
	MessageReceived *MessageReceived `protobuf:"bytes,17,opt,name=message_received,json=messageReceived,proto3,oneof"`
}

type Event_Deliver struct {
	Deliver *Deliver `protobuf:"bytes,18,opt,name=deliver,proto3,oneof"`
}

type Event_Iss struct {
	Iss *isspb.ISSEvent `protobuf:"bytes,19,opt,name=iss,proto3,oneof"`
}

type Event_VerifyRequestSig struct {
	VerifyRequestSig *VerifyRequestSig `protobuf:"bytes,20,opt,name=verify_request_sig,json=verifyRequestSig,proto3,oneof"`
}

type Event_RequestSigVerified struct {
	RequestSigVerified *RequestSigVerified `protobuf:"bytes,21,opt,name=request_sig_verified,json=requestSigVerified,proto3,oneof"`
}

type Event_StoreVerifiedRequest struct {
	StoreVerifiedRequest *StoreVerifiedRequest `protobuf:"bytes,22,opt,name=store_verified_request,json=storeVerifiedRequest,proto3,oneof"`
}

type Event_AppSnapshotRequest struct {
	AppSnapshotRequest *AppSnapshotRequest `protobuf:"bytes,23,opt,name=app_snapshot_request,json=appSnapshotRequest,proto3,oneof"`
}

type Event_AppSnapshot struct {
	AppSnapshot *AppSnapshot `protobuf:"bytes,24,opt,name=app_snapshot,json=appSnapshot,proto3,oneof"`
}
...
func (*Event_VerifyNodeSig) isEvent_Type() {}

func (*Event_NodeSigVerified) isEvent_Type() {}

func (*Event_VerifyNodeSigBatch) isEvent_Type() {}

func (*Event_NodeSigBatchVerified) isEvent_Type() {}
...
type VerifyNodeSig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Data      *SigVerData   `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	Signature []byte        `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`
	Origin    *SigVerOrigin `protobuf:"bytes,3,opt,name=origin,proto3" json:"origin,omitempty"`
	NodeId    string        `protobuf:"bytes,4,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
}

func (x *VerifyNodeSig) Reset() {
	*x = VerifyNodeSig{}
	if protoimpl.UnsafeEnabled {
...
func (x *VerifyNodeSig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyNodeSig) ProtoMessage() {}

func (x *VerifyNodeSig) ProtoReflect() protoreflect.Message {
	mi := &file_eventpb_eventpb_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyNodeSig.ProtoReflect.Descriptor instead.
func (*VerifyNodeSig) Descriptor() ([]byte, []int) {
	return file_eventpb_eventpb_proto_rawDescGZIP(), []int{10}
}

func (x *VerifyNodeSig) GetData() *SigVerData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *VerifyNodeSig) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *VerifyNodeSig) GetOrigin() *SigVerOrigin {
	if x != nil {
		return x.Origin
	}
	return nil
...
func (x *VerifyNodeSig) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *NodeSigVerified) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeSigVerified) ProtoMessage() {}

func (x *NodeSigVerified) ProtoReflect() protoreflect.Message {
	mi := &file_eventpb_eventpb_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeSigVerified.ProtoReflect.Descriptor instead.
func (*NodeSigVerified) Descriptor() ([]byte, []int) {
	return file_eventpb_eventpb_proto_rawDescGZIP(), []int{11}
}

func (x *NodeSigVerified) GetOrigin() *SigVerOrigin {
	if x != nil {
		return x.Origin
	}
	return nil
...
func (x *NodeSigVerified) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *NodeSigVerified) GetValid() bool {
	if x != nil {
		return x.Valid
	}
	return false
...
func (x *NodeSigVerified) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type VerifyNodeSigBatch struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VerifyNodeSigBatch) Reset() {
	*x = VerifyNodeSigBatch{}
	if protoimpl.UnsafeEnabled {
...
func (x *VerifyNodeSigBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyNodeSigBatch) ProtoMessage() {}

func (x *VerifyNodeSigBatch) ProtoReflect() protoreflect.Message {
	mi := &file_eventpb_eventpb_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyNodeSigBatch.ProtoReflect.Descriptor instead.
func (*VerifyNodeSigBatch) Descriptor() ([]byte, []int) {
	return file_eventpb_eventpb_proto_rawDescGZIP(), []int{12}
}

func (x *VerifyNodeSigBatch) GetData() []*SigVerData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *VerifyNodeSigBatch) GetSignatures() [][]byte {
	if x != nil {
		return x.Signatures
	}
	return nil
...
func (x *VerifyNodeSigBatch) GetOrigin() *SigVerOrigin {
	if x != nil {
		return x.Origin
	}
	return nil
...
func (x *VerifyNodeSigBatch) GetNodeIds() []string {
	if x != nil {
		return x.NodeIds
	}
	return nil
...
type NodeSigBatchVerified struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *NodeSigBatchVerified) Reset() {
	*x = NodeSigBatchVerified{}
	if protoimpl.UnsafeEnabled {
...
func (x *NodeSigBatchVerified) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeSigBatchVerified) ProtoMessage() {}

func (x *NodeSigBatchVerified) ProtoReflect() protoreflect.Message {
	mi := &file_eventpb_eventpb_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeSigBatchVerified.ProtoReflect.Descriptor instead.
func (*NodeSigBatchVerified) Descriptor() ([]byte, []int) {
	return file_eventpb_eventpb_proto_rawDescGZIP(), []int{13}
}

func (x *NodeSigBatchVerified) GetOrigin() *SigVerOrigin {
	if x != nil {
		return x.Origin
	}
	return nil
...
func (x *NodeSigBatchVerified) GetNodeIds() []string {
	if x != nil {
		return x.NodeIds
	}
	return nil
...
func (x *NodeSigBatchVerified) GetValid() []bool {
	if x != nil {
		return x.Valid
	}
	return nil
...
func (x *NodeSigBatchVerified) GetError() []string {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *NodeSigBatchVerified) GetAllOk() bool {
	if x != nil {
		return x.AllOk
	}
	return false
...
type SigVerOrigin_Iss struct {
	Iss *isspb.ISSSigVerOrigin `protobuf:"bytes,1,opt,name=iss,proto3,oneof"`
}
...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe8, 0x0d, 0x0a, 0x05, 0x45, 0x76,
	...
	0x73, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74,
	...
	0x0b, 0x73, 0x69, 0x67, 0x6e, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x0a, 0x20, 0x01,
	...
	,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	...
	0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x65,
	...
	0x65, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x12, 0x2c, 0x0a, 0x07, 0x64, 0x65, 0x6c,
	0x69, 0x76, 0x65, 0x72, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x48, 0x00, 0x52, 0x07,
	0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x03, 0x69, 0x73, 0x73, 0x18, 0x13,
	...
	0x69, 0x67, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74,
	...
	0x15, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e,
	...
	0x73, 0x74, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	...
	,
	...
	0x69, 0x67, 0x69, 0x6e, 0x22, 0x51, 0x0a, 0x0a, 0x48, 0x61, 0x73, 0x68, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x06, 0x6f, 0x72,
	...
	0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x22, 0x6e, 0x0a, 0x0a, 0x48, 0x61, 0x73, 0x68, 0x4f,
	0x72, 0x69, 0x67, 0x69, 0x6e, 0x12, 0x2e, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x28, 0x0a, 0x03, 0x69, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x14, 0x2e, 0x69, 0x73, 0x73, 0x70, 0x62, 0x2e, 0x49, 0x53, 0x53, 0x48, 0x61,
	0x73, 0x68, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x48, 0x00, 0x52, 0x03, 0x69, 0x73, 0x73, 0x42,
	...
	,
	...
	0x69, 0x6e, 0x52, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x6e, 0x6f,
	0x64, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6e, 0x6f, 0x64,
	0x65, 0x49, 0x64, 0x22, 0x85, 0x01, 0x0a, 0x0f, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x69, 0x67, 0x56,
	0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x2d, 0x0a, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70,
	0x62, 0x2e, 0x53, 0x69, 0x67, 0x56, 0x65, 0x72, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x52, 0x06,
	0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x69,
	...
	0x76, 0x61, 0x6c, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xa7, 0x01, 0x0a, 0x12,
	0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x69, 0x67, 0x42, 0x61, 0x74,
	0x63, 0x68, 0x12, 0x27, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	0x64, 0x65, 0x49, 0x64, 0x73, 0x22, 0xa3, 0x01, 0x0a, 0x14, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x69,
	0x67, 0x42, 0x61, 0x74, 0x63, 0x68, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x2d,
	...
	,
	...
	0x22, 0x4b, 0x0a, 0x0f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x63, 0x65, 0x69,
	0x76, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x12, 0x24, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x70, 0x62,
	0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x5a, 0x0a,
	...
	0x64, 0x65, 0x78, 0x22, 0x41, 0x0a, 0x07, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x12, 0x0e,
	...
	0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x22, 0x68, 0x0a, 0x10, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x69, 0x67, 0x12, 0x36, 0x0a, 0x0b, 0x72, 0x65,
	...
	0x65, 0x66, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x22, 0x78, 0x0a, 0x12, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x69, 0x67, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x36, 0x0a, 0x0b, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x65, 0x66, 0x52, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x66, 0x12, 0x14,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x88, 0x01, 0x0a, 0x14, 0x53,
	0x74, 0x6f, 0x72, 0x65, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x0b, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x72,
	...
	0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x66, 0x12, 0x12, 0x0a, 0x04, 0x64,
	...
	,
	...
	0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x22, 0x4c, 0x0a, 0x12,
	...
	0x74, 0x63, 0x68, 0x52, 0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69,
...
var file_eventpb_eventpb_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*VerifyNodeSig)(nil),         // 10: eventpb.VerifyNodeSig
	(*NodeSigVerified)(nil),       // 11: eventpb.NodeSigVerified
	(*VerifyNodeSigBatch)(nil),    // 12: eventpb.VerifyNodeSigBatch
	(*NodeSigBatchVerified)(nil),  // 13: eventpb.NodeSigBatchVerified
	...
	(*StoreDummyRequest)(nil),     // 27: eventpb.StoreDummyRequest
	(*PersistDummyBatch)(nil),     // 28: eventpb.PersistDummyBatch
	(*AnnounceDummyBatch)(nil),    // 29: eventpb.AnnounceDummyBatch
	(*requestpb.Request)(nil),     // 30: requestpb.Request
	(*isspb.ISSEvent)(nil),        // 31: isspb.ISSEvent
	(*isspb.ISSHashOrigin)(nil),   // 32: isspb.ISSHashOrigin
	(*isspb.ISSSignOrigin)(nil),   // 33: isspb.ISSSignOrigin
	(*isspb.ISSSigVerOrigin)(nil), // 34: isspb.ISSSigVerOrigin
	(*requestpb.RequestRef)(nil),  // 35: requestpb.RequestRef
	(*messagepb.Message)(nil),     // 36: messagepb.Message
	(*requestpb.Batch)(nil),       // 37: requestpb.Batch
}
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	30, // 5: eventpb.Event.request:type_name -> requestpb.Request
	3,  // 6: eventpb.Event.hash_request:type_name -> eventpb.HashRequest
	4,  // 7: eventpb.Event.hash_result:type_name -> eventpb.HashResult
	6,  // 8: eventpb.Event.sign_request:type_name -> eventpb.SignRequest
	7,  // 9: eventpb.Event.sign_result:type_name -> eventpb.SignResult
	10, // 10: eventpb.Event.verify_node_sig:type_name -> eventpb.VerifyNodeSig
	11, // 11: eventpb.Event.node_sig_verified:type_name -> eventpb.NodeSigVerified
	12, // 12: eventpb.Event.verify_node_sig_batch:type_name -> eventpb.VerifyNodeSigBatch
	13, // 13: eventpb.Event.node_sig_batch_verified:type_name -> eventpb.NodeSigBatchVerified
	15, // 14: eventpb.Event.request_ready:type_name -> eventpb.RequestReady
	16, // 15: eventpb.Event.send_message:type_name -> eventpb.SendMessage
	17, // 16: eventpb.Event.message_received:type_name -> eventpb.MessageReceived
	21, // 17: eventpb.Event.deliver:type_name -> eventpb.Deliver
	31, // 18: eventpb.Event.iss:type_name -> isspb.ISSEvent
	22, // 19: eventpb.Event.verify_request_sig:type_name -> eventpb.VerifyRequestSig
	23, // 20: eventpb.Event.request_sig_verified:type_name -> eventpb.RequestSigVerified
	24, // 21: eventpb.Event.store_verified_request:type_name -> eventpb.StoreVerifiedRequest
	25, // 22: eventpb.Event.app_snapshot_request:type_name -> eventpb.AppSnapshotRequest
	26, // 23: eventpb.Event.app_snapshot:type_name -> eventpb.AppSnapshot
	28, // 24: eventpb.Event.persist_dummy_batch:type_name -> eventpb.PersistDummyBatch
	29, // 25: eventpb.Event.announce_dummy_batch:type_name -> eventpb.AnnounceDummyBatch
	27, // 26: eventpb.Event.store_dummy_request:type_name -> eventpb.StoreDummyRequest
	0,  // 27: eventpb.Event.next:type_name -> eventpb.Event
	5,  // 28: eventpb.HashRequest.origin:type_name -> eventpb.HashOrigin
	5,  // 29: eventpb.HashResult.origin:type_name -> eventpb.HashOrigin
	30, // 30: eventpb.HashOrigin.request:type_name -> requestpb.Request
	32, // 31: eventpb.HashOrigin.iss:type_name -> isspb.ISSHashOrigin
	8,  // 32: eventpb.SignRequest.origin:type_name -> eventpb.SignOrigin
	8,  // 33: eventpb.SignResult.origin:type_name -> eventpb.SignOrigin
	33, // 34: eventpb.SignOrigin.iss:type_name -> isspb.ISSSignOrigin
	9,  // 35: eventpb.VerifyNodeSig.data:type_name -> eventpb.SigVerData
	14, // 36: eventpb.VerifyNodeSig.origin:type_name -> eventpb.SigVerOrigin
	14, // 37: eventpb.NodeSigVerified.origin:type_name -> eventpb.SigVerOrigin
	9,  // 38: eventpb.VerifyNodeSigBatch.data:type_name -> eventpb.SigVerData
	14, // 39: eventpb.VerifyNodeSigBatch.origin:type_name -> eventpb.SigVerOrigin
	14, // 40: eventpb.NodeSigBatchVerified.origin:type_name -> eventpb.SigVerOrigin
	34, // 41: eventpb.SigVerOrigin.iss:type_name -> isspb.ISSSigVerOrigin
	35, // 42: eventpb.RequestReady.request_ref:type_name -> requestpb.RequestRef
	36, // 43: eventpb.SendMessage.msg:type_name -> messagepb.Message
	36, // 44: eventpb.MessageReceived.msg:type_name -> messagepb.Message
	0,  // 45: eventpb.WALAppend.event:type_name -> eventpb.Event
	0,  // 46: eventpb.WALEntry.event:type_name -> eventpb.Event
	37, // 47: eventpb.Deliver.batch:type_name -> requestpb.Batch
	35, // 48: eventpb.VerifyRequestSig.request_ref:type_name -> requestpb.RequestRef
	35, // 49: eventpb.RequestSigVerified.request_ref:type_name -> requestpb.RequestRef
	35, // 50: eventpb.StoreVerifiedRequest.request_ref:type_name -> requestpb.RequestRef
	35, // 51: eventpb.StoreDummyRequest.request_ref:type_name -> requestpb.RequestRef
	37, // 52: eventpb.PersistDummyBatch.batch:type_name -> requestpb.Batch
	37, // 53: eventpb.AnnounceDummyBatch.batch:type_name -> requestpb.Batch
...
func file_eventpb_eventpb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eventpb_eventpb_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VerifyNodeSigBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eventpb_eventpb_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NodeSigBatchVerified); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_eventpb_eventpb_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Event_VerifyNodeSig)(nil),
		(*Event_NodeSigVerified)(nil),
		(*Event_VerifyNodeSigBatch)(nil),
		(*Event_NodeSigBatchVerified)(nil),
