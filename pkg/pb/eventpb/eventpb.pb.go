...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xa5, 0x14, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69,
	...
	0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x07, 0x73, 0x62, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x37,
	0x0a, 0x0c, 0x6e, 0x65, 0x77, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x28,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x4e,
	0x65, 0x77, 0x4c, 0x6f, 0x67, 0x46, 0x69, 0x6c, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x6e, 0x65, 0x77,
	0x4c, 0x6f, 0x67, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x69,
	...
	0x07, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x4e, 0x72, 0x22, 0x5c, 0x0a, 0x09, 0x4e, 0x65, 0x77, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x6e,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x4e, 0x72,
	0x12, 0x34, 0x0a, 0x0a, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x18, 0x02,
	...
	0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x22, 0x0c, 0x0a, 0x0a, 0x4e, 0x65, 0x77, 0x4c, 0x6f, 0x67,
...
var file_eventpb_eventpb_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*NewLogFile)(nil),                        // 33: eventpb.NewLogFile
	(*isspb.ISSEvent)(nil),                    // 34: isspb.ISSEvent
	(*bcbpb.Event)(nil),                       // 35: bcbpb.Event
	(*mempoolpb.Event)(nil),                   // 36: mempoolpb.Event
	(*availabilitypb.Event)(nil),              // 37: availabilitypb.Event
	(*factorymodulepb.Factory)(nil),           // 38: factorymodulepb.Factory
	(*batchdbpb.Event)(nil),                   // 39: batchdbpb.Event
	(*batchfetcherpb.Event)(nil),              // 40: batchfetcherpb.Event
	(*threshcryptopb.Event)(nil),              // 41: threshcryptopb.Event
	(*pingpongpb.Event)(nil),                  // 42: pingpongpb.Event
	(*checkpointpb.Event)(nil),                // 43: checkpointpb.Event
	(*ordererspb.SBInstanceEvent)(nil),        // 44: ordererspb.SBInstanceEvent
	...
	(*ordererspb.SBInstanceHashOrigin)(nil),   // 53: ordererspb.SBInstanceHashOrigin
	(*checkpointpb.SignOrigin)(nil),           // 54: checkpointpb.SignOrigin
	(*ordererspb.SBInstanceSignOrigin)(nil),   // 55: ordererspb.SBInstanceSignOrigin
	(*isspb.ISSSigVerOrigin)(nil),             // 56: isspb.ISSSigVerOrigin
	(*checkpointpb.SigVerOrigin)(nil),         // 57: checkpointpb.SigVerOrigin
	(*ordererspb.SBInstanceSigVerOrigin)(nil), // 58: ordererspb.SBInstanceSigVerOrigin
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	34, // 16: eventpb.Event.iss:type_name -> isspb.ISSEvent
	...
	35, // 26: eventpb.Event.bcb:type_name -> bcbpb.Event
	36, // 27: eventpb.Event.mempool:type_name -> mempoolpb.Event
	37, // 28: eventpb.Event.availability:type_name -> availabilitypb.Event
	31, // 29: eventpb.Event.new_epoch:type_name -> eventpb.NewEpoch
	32, // 30: eventpb.Event.new_config:type_name -> eventpb.NewConfig
	38, // 31: eventpb.Event.factory:type_name -> factorymodulepb.Factory
	39, // 32: eventpb.Event.batch_db:type_name -> batchdbpb.Event
	40, // 33: eventpb.Event.batch_fetcher:type_name -> batchfetcherpb.Event
	41, // 34: eventpb.Event.thresh_crypto:type_name -> threshcryptopb.Event
	42, // 35: eventpb.Event.ping_pong:type_name -> pingpongpb.Event
	43, // 36: eventpb.Event.checkpoint:type_name -> checkpointpb.Event
	44, // 37: eventpb.Event.sb_event:type_name -> ordererspb.SBInstanceEvent
	33, // 38: eventpb.Event.new_log_file:type_name -> eventpb.NewLogFile
	...
	49, // 61: eventpb.SigVerOrigin.context_store:type_name -> contextstorepb.Origin
	56, // 62: eventpb.SigVerOrigin.iss:type_name -> isspb.ISSSigVerOrigin
	51, // 63: eventpb.SigVerOrigin.dsl:type_name -> dslpb.Origin
	57, // 64: eventpb.SigVerOrigin.checkpoint:type_name -> checkpointpb.SigVerOrigin
	58, // 65: eventpb.SigVerOrigin.sb:type_name -> ordererspb.SBInstanceSigVerOrigin
	47, // 66: eventpb.RequestReady.request:type_name -> requestpb.Request
	...
	47, // 72: eventpb.VerifyRequestSig.request:type_name -> requestpb.Request
	47, // 73: eventpb.RequestSigVerified.request:type_name -> requestpb.Request
	47, // 74: eventpb.StoreVerifiedRequest.request:type_name -> requestpb.Request
