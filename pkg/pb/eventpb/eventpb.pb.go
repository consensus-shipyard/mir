...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x6c, 0x70, 0x62, 0x2f, 0x64, 0x73, 0x6c, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0xfe, 0x0e, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e, 0x69,
	...
	0x63, 0x62, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x72,
	...
	0x57, 0x41, 0x4c, 0x4c, 0x6f, 0x61, 0x64, 0x41, 0x6c, 0x6c, 0x22, 0x41, 0x0a, 0x07, 0x44, 0x65,
	...
	0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x22, 0x5e, 0x0a,
	...
	0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x42, 0x0a,
	...
	,
	...
	0x01, 0x28, 0x04, 0x52, 0x0e, 0x72, 0x65, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e,
	0x64, 0x65, 0x78, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*contextstorepb.Origin)(nil),  // 37: contextstorepb.Origin
	(*isspb.ISSHashOrigin)(nil),    // 38: isspb.ISSHashOrigin
	(*dslpb.Origin)(nil),           // 39: dslpb.Origin
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	33, // 28: eventpb.Event.testingString:type_name -> google.protobuf.StringValue
	34, // 29: eventpb.Event.testingUint:type_name -> google.protobuf.UInt64Value
	0,  // 30: eventpb.Event.next:type_name -> eventpb.Event
	35, // 31: eventpb.NewRequests.requests:type_name -> requestpb.Request
	36, // 32: eventpb.HashRequest.data:type_name -> commonpb.HashData
	6,  // 33: eventpb.HashRequest.origin:type_name -> eventpb.HashOrigin
	6,  // 34: eventpb.HashResult.origin:type_name -> eventpb.HashOrigin
	37, // 35: eventpb.HashOrigin.context_store:type_name -> contextstorepb.Origin
	35, // 36: eventpb.HashOrigin.request:type_name -> requestpb.Request
	38, // 37: eventpb.HashOrigin.iss:type_name -> isspb.ISSHashOrigin
	39, // 38: eventpb.HashOrigin.dsl:type_name -> dslpb.Origin
	9,  // 39: eventpb.SignRequest.origin:type_name -> eventpb.SignOrigin
	9,  // 40: eventpb.SignResult.origin:type_name -> eventpb.SignOrigin
	37, // 41: eventpb.SignOrigin.context_store:type_name -> contextstorepb.Origin
	40, // 42: eventpb.SignOrigin.iss:type_name -> isspb.ISSSignOrigin
	39, // 43: eventpb.SignOrigin.dsl:type_name -> dslpb.Origin
	10, // 44: eventpb.VerifyNodeSigs.data:type_name -> eventpb.SigVerData
	13, // 45: eventpb.VerifyNodeSigs.origin:type_name -> eventpb.SigVerOrigin
	13, // 46: eventpb.NodeSigsVerified.origin:type_name -> eventpb.SigVerOrigin
	37, // 47: eventpb.SigVerOrigin.context_store:type_name -> contextstorepb.Origin
	41, // 48: eventpb.SigVerOrigin.iss:type_name -> isspb.ISSSigVerOrigin
	39, // 49: eventpb.SigVerOrigin.dsl:type_name -> dslpb.Origin
	35, // 50: eventpb.RequestReady.request:type_name -> requestpb.Request
	...
	35, // 56: eventpb.VerifyRequestSig.request:type_name -> requestpb.Request
	35, // 57: eventpb.RequestSigVerified.request:type_name -> requestpb.Request
	35, // 58: eventpb.StoreVerifiedRequest.request:type_name -> requestpb.Request
