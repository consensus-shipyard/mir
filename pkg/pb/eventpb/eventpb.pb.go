...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0xe9, 0x0f, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e, 0x69,
	...
	0x0c, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x45, 0x0a,
	...
	0x61, 0x64, 0x41, 0x6c, 0x6c, 0x22, 0x41, 0x0a, 0x07, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72,
	...
	0x68, 0x52, 0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x22, 0x5e, 0x0a, 0x10, 0x56, 0x65, 0x72, 0x69,
	...
	0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x42, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x53,
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x37, 0x0a, 0x0b,
	...
	0x72, 0x65, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42, 0x30,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*bcbpb.Event)(nil),            // 32: bcbpb.Event
	(*mempoolpb.Event)(nil),        // 33: mempoolpb.Event
	(*availabilitypb.Event)(nil),   // 34: availabilitypb.Event
	...
	(*contextstorepb.Origin)(nil),  // 39: contextstorepb.Origin
	(*isspb.ISSHashOrigin)(nil),    // 40: isspb.ISSHashOrigin
	(*dslpb.Origin)(nil),           // 41: dslpb.Origin
	(*isspb.ISSSignOrigin)(nil),    // 42: isspb.ISSSignOrigin
	(*isspb.ISSSigVerOrigin)(nil),  // 43: isspb.ISSSigVerOrigin
	(*messagepb.Message)(nil),      // 44: messagepb.Message
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	32, // 27: eventpb.Event.bcb:type_name -> bcbpb.Event
	33, // 28: eventpb.Event.mempool:type_name -> mempoolpb.Event
	34, // 29: eventpb.Event.availability:type_name -> availabilitypb.Event
	35, // 30: eventpb.Event.testingString:type_name -> google.protobuf.StringValue
	36, // 31: eventpb.Event.testingUint:type_name -> google.protobuf.UInt64Value
	0,  // 32: eventpb.Event.next:type_name -> eventpb.Event
	37, // 33: eventpb.NewRequests.requests:type_name -> requestpb.Request
	38, // 34: eventpb.HashRequest.data:type_name -> commonpb.HashData
	6,  // 35: eventpb.HashRequest.origin:type_name -> eventpb.HashOrigin
	6,  // 36: eventpb.HashResult.origin:type_name -> eventpb.HashOrigin
	39, // 37: eventpb.HashOrigin.context_store:type_name -> contextstorepb.Origin
	37, // 38: eventpb.HashOrigin.request:type_name -> requestpb.Request
	40, // 39: eventpb.HashOrigin.iss:type_name -> isspb.ISSHashOrigin
	41, // 40: eventpb.HashOrigin.dsl:type_name -> dslpb.Origin
	9,  // 41: eventpb.SignRequest.origin:type_name -> eventpb.SignOrigin
	9,  // 42: eventpb.SignResult.origin:type_name -> eventpb.SignOrigin
	39, // 43: eventpb.SignOrigin.context_store:type_name -> contextstorepb.Origin
	42, // 44: eventpb.SignOrigin.iss:type_name -> isspb.ISSSignOrigin
	41, // 45: eventpb.SignOrigin.dsl:type_name -> dslpb.Origin
	10, // 46: eventpb.VerifyNodeSigs.data:type_name -> eventpb.SigVerData
	13, // 47: eventpb.VerifyNodeSigs.origin:type_name -> eventpb.SigVerOrigin
	13, // 48: eventpb.NodeSigsVerified.origin:type_name -> eventpb.SigVerOrigin
	39, // 49: eventpb.SigVerOrigin.context_store:type_name -> contextstorepb.Origin
	43, // 50: eventpb.SigVerOrigin.iss:type_name -> isspb.ISSSigVerOrigin
	41, // 51: eventpb.SigVerOrigin.dsl:type_name -> dslpb.Origin
	37, // 52: eventpb.RequestReady.request:type_name -> requestpb.Request
	44, // 53: eventpb.SendMessage.msg:type_name -> messagepb.Message
	44, // 54: eventpb.MessageReceived.msg:type_name -> messagepb.Message
	0,  // 55: eventpb.WALAppend.event:type_name -> eventpb.Event
	0,  // 56: eventpb.WALEntry.event:type_name -> eventpb.Event
	45, // 57: eventpb.Deliver.batch:type_name -> requestpb.Batch
	37, // 58: eventpb.VerifyRequestSig.request:type_name -> requestpb.Request
	37, // 59: eventpb.RequestSigVerified.request:type_name -> requestpb.Request
	37, // 60: eventpb.StoreVerifiedRequest.request:type_name -> requestpb.Request
	0,  // 61: eventpb.TimerDelay.events:type_name -> eventpb.Event
	0,  // 62: eventpb.TimerRepeat.events:type_name -> eventpb.Event
