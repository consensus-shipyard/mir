...
type Event_Timer struct {
	...
	Timer *TimerEvent `protobuf:"bytes,2,opt,name=timer,proto3,oneof"`
}
...
type Event_Transport struct {
	Transport *transportpb.Event `protobuf:"bytes,42,opt,name=transport,proto3,oneof"`
}
...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x22, 0xc6, 0x08, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e,
	...
	0x2b, 0x0a, 0x05, 0x74, 0x69, 0x6d, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13,
	0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x05, 0x74, 0x69, 0x6d, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x06,
	0x68, 0x61, 0x73, 0x68, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x68,
	0x61, 0x73, 0x68, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52,
	0x06, 0x68, 0x61, 0x73, 0x68, 0x65, 0x72, 0x12, 0x20, 0x0a, 0x03, 0x62, 0x63, 0x62, 0x18, 0x1c,
	...
	0x6f, 0x72, 0x79, 0x18, 0x21, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x66, 0x61, 0x63, 0x74,
	0x6f, 0x72, 0x79, 0x70, 0x62, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x07, 0x66,
	0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x20, 0x0a, 0x03, 0x69, 0x73, 0x73, 0x18, 0x12, 0x20,
	...
	0x72, 0x65, 0x72, 0x18, 0x27, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	...
	0x18, 0x28, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x70,
	0x62, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x06, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x6f, 0x12, 0x20, 0x0a, 0x03, 0x61, 0x70, 0x70, 0x18, 0x29, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c,
	...
	0x18, 0x2a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f,
	0x72, 0x74, 0x70, 0x62, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x09, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x69,
	...
	0x74, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x22, 0xc6, 0x01, 0x0a, 0x0a, 0x54, 0x69, 0x6d, 0x65,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*pingpongpb.Event)(nil),       // 13: pingpongpb.Event
	(*checkpointpb.Event)(nil),     // 14: checkpointpb.Event
	(*factorypb.Event)(nil),        // 15: factorypb.Event
	(*isspb.Event)(nil),            // 16: isspb.Event
	(*ordererpb.Event)(nil),        // 17: ordererpb.Event
	(*cryptopb.Event)(nil),         // 18: cryptopb.Event
	(*apppb.Event)(nil),            // 19: apppb.Event
	(*transportpb.Event)(nil),      // 20: transportpb.Event
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	13, // 9: eventpb.Event.ping_pong:type_name -> pingpongpb.Event
	14, // 10: eventpb.Event.checkpoint:type_name -> checkpointpb.Event
	15, // 11: eventpb.Event.factory:type_name -> factorypb.Event
	16, // 12: eventpb.Event.iss:type_name -> isspb.Event
	17, // 13: eventpb.Event.orderer:type_name -> ordererpb.Event
	18, // 14: eventpb.Event.crypto:type_name -> cryptopb.Event
	19, // 15: eventpb.Event.app:type_name -> apppb.Event
	20, // 16: eventpb.Event.transport:type_name -> transportpb.Event
