...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x09, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x69,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x22, 0x93, 0x01, 0x0a,
	...
	0x65, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x22, 0xc6, 0x01, 0x0a,
	...
	0x04, 0x80, 0xa6, 0x1d, 0x01, 0x22, 0x9c, 0x01, 0x0a, 0x0a, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x44,
	...
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x54, 0x6f, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x50, 0x0a, 0x05,
	0x64, 0x65, 0x6c, 0x61, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x42, 0x3a, 0x82, 0xa6, 0x1d,
	...
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x44,
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x3a, 0x04,
	0x98, 0xa6, 0x1d, 0x01, 0x22, 0x86, 0x02, 0x0a, 0x0b, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x52, 0x65,
...
var file_eventpb_eventpb_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*TimerEvent)(nil),             // 5: eventpb.TimerEvent
	(*TimerDelay)(nil),             // 6: eventpb.TimerDelay
	(*TimerRepeat)(nil),            // 7: eventpb.TimerRepeat
	(*TimerGarbageCollect)(nil),    // 8: eventpb.TimerGarbageCollect
	(*hasherpb.Event)(nil),         // 9: hasherpb.Event
	(*bcbpb.Event)(nil),            // 10: bcbpb.Event
	(*mempoolpb.Event)(nil),        // 11: mempoolpb.Event
	(*availabilitypb.Event)(nil),   // 12: availabilitypb.Event
	(*batchdbpb.Event)(nil),        // 13: batchdbpb.Event
	(*batchfetcherpb.Event)(nil),   // 14: batchfetcherpb.Event
	(*threshcryptopb.Event)(nil),   // 15: threshcryptopb.Event
	(*pingpongpb.Event)(nil),       // 16: pingpongpb.Event
	(*checkpointpb.Event)(nil),     // 17: checkpointpb.Event
	(*factorypb.Event)(nil),        // 18: factorypb.Event
	(*isspb.Event)(nil),            // 19: isspb.Event
	(*ordererpb.Event)(nil),        // 20: ordererpb.Event
	(*cryptopb.Event)(nil),         // 21: cryptopb.Event
	(*apppb.Event)(nil),            // 22: apppb.Event
	(*wrapperspb.StringValue)(nil), // 23: google.protobuf.StringValue
	(*wrapperspb.UInt64Value)(nil), // 24: google.protobuf.UInt64Value
	(*requestpb.Request)(nil),      // 25: requestpb.Request
	(*messagepb.Message)(nil),      // 26: messagepb.Message
}
var file_eventpb_eventpb_proto_depIdxs = []int32{
	1,  // 0: eventpb.Event.init:type_name -> eventpb.Init
	5,  // 1: eventpb.Event.timer:type_name -> eventpb.TimerEvent
	9,  // 2: eventpb.Event.hasher:type_name -> hasherpb.Event
	10, // 3: eventpb.Event.bcb:type_name -> bcbpb.Event
	11, // 4: eventpb.Event.mempool:type_name -> mempoolpb.Event
	12, // 5: eventpb.Event.availability:type_name -> availabilitypb.Event
	13, // 6: eventpb.Event.batch_db:type_name -> batchdbpb.Event
	14, // 7: eventpb.Event.batch_fetcher:type_name -> batchfetcherpb.Event
	15, // 8: eventpb.Event.thresh_crypto:type_name -> threshcryptopb.Event
	16, // 9: eventpb.Event.ping_pong:type_name -> pingpongpb.Event
	17, // 10: eventpb.Event.checkpoint:type_name -> checkpointpb.Event
	18, // 11: eventpb.Event.factory:type_name -> factorypb.Event
	19, // 12: eventpb.Event.iss:type_name -> isspb.Event
	20, // 13: eventpb.Event.orderer:type_name -> ordererpb.Event
	21, // 14: eventpb.Event.crypto:type_name -> cryptopb.Event
	22, // 15: eventpb.Event.app:type_name -> apppb.Event
	...
	2,  // 18: eventpb.Event.new_requests:type_name -> eventpb.NewRequests
	...
	25, // 22: eventpb.NewRequests.requests:type_name -> requestpb.Request
	26, // 23: eventpb.SendMessage.msg:type_name -> messagepb.Message
	26, // 24: eventpb.MessageReceived.msg:type_name -> messagepb.Message
	6,  // 25: eventpb.TimerEvent.delay:type_name -> eventpb.TimerDelay
	7,  // 26: eventpb.TimerEvent.repeat:type_name -> eventpb.TimerRepeat
	8,  // 27: eventpb.TimerEvent.garbage_collect:type_name -> eventpb.TimerGarbageCollect
	0,  // 28: eventpb.TimerDelay.events_to_delay:type_name -> eventpb.Event
	0,  // 29: eventpb.TimerRepeat.events_to_repeat:type_name -> eventpb.Event
