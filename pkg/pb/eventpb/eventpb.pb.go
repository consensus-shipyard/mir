...
type Event_Application struct {
	Application *applicationpb.Event `protobuf:"bytes,206,opt,name=application,proto3,oneof"`
}
...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe1, 0x0c, 0x0a, 0x05, 0x45,
	...
	0x0a, 0x0b, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0xce, 0x01,
	...
	0x6e, 0x74, 0x65, 0x72, 0x63, 0x65, 0x70, 0x74, 0x6f, 0x72, 0x18, 0xd2, 0x01, 0x20, 0x01, 0x28,
	...
	0x65, 0x72, 0x63, 0x65, 0x70, 0x74, 0x6f, 0x72, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74,
	...
	0x90, 0xa6, 0x1d, 0x01, 0x52, 0x04, 0x6e, 0x65, 0x78, 0x74, 0x3a, 0x04, 0x88, 0xa6, 0x1d, 0x01,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*applicationpb.Event)(nil),    // 28: applicationpb.Event
	(*interceptorpb.Event)(nil),    // 29: interceptorpb.Event
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	28, // 24: eventpb.Event.application:type_name -> applicationpb.Event
	29, // 25: eventpb.Event.bcinterceptor:type_name -> interceptorpb.Event
