...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x22, 0xdc, 0x09, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x56, 0x0a, 0x0b, 0x64, 0x65,
	...
	0x6c, 0x65, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0d, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x48,
	0x00, 0x52, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x12, 0x29, 0x0a, 0x06, 0x68, 0x61, 0x73, 0x68, 0x65,
	...
	,
	...
	0x00, 0x52, 0x0b, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x55, 0x69, 0x6e, 0x74, 0x12, 0x2b,
	0x0a, 0x06, 0x74, 0x65, 0x73, 0x74, 0x65, 0x72, 0x18, 0xaf, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x65,
	0x72, 0x48, 0x00, 0x52, 0x06, 0x74, 0x65, 0x73, 0x74, 0x65, 0x72, 0x3a, 0x04, 0x88, 0xa6, 0x1d,
	0x01, 0x42, 0x0c, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x04, 0x80, 0xa6, 0x1d, 0x01, 0x22,
	0x0c, 0x0a, 0x04, 0x49, 0x6e, 0x69, 0x74, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x22, 0x25, 0x0a,
	0x0f, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*SerializedEvent)(nil),        // 2: eventpb.SerializedEvent
	...
	(*factorypb.Event)(nil),        // 11: factorypb.Event
	(*isspb.Event)(nil),            // 12: isspb.Event
	(*ordererpb.Event)(nil),        // 13: ordererpb.Event
	(*cryptopb.Event)(nil),         // 14: cryptopb.Event
	(*apppb.Event)(nil),            // 15: apppb.Event
	(*transportpb.Event)(nil),      // 16: transportpb.Event
	(*chkpvalidatorpb.Event)(nil),  // 17: chkpvalidatorpb.Event
	(*pprepvalidatorpb.Event)(nil), // 18: pprepvalidatorpb.Event
	...
	(*testerpb.Tester)(nil),        // 22: testerpb.Tester
}
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	11, // 9: eventpb.Event.factory:type_name -> factorypb.Event
	12, // 10: eventpb.Event.iss:type_name -> isspb.Event
	13, // 11: eventpb.Event.orderer:type_name -> ordererpb.Event
	14, // 12: eventpb.Event.crypto:type_name -> cryptopb.Event
	15, // 13: eventpb.Event.app:type_name -> apppb.Event
	16, // 14: eventpb.Event.transport:type_name -> transportpb.Event
	17, // 15: eventpb.Event.chkp_validator:type_name -> chkpvalidatorpb.Event
	18, // 16: eventpb.Event.pprep_valiadtor:type_name -> pprepvalidatorpb.Event
	2,  // 17: eventpb.Event.serialized:type_name -> eventpb.SerializedEvent
	19, // 18: eventpb.Event.ping_pong:type_name -> pingpongpb.Event
	20, // 19: eventpb.Event.testingString:type_name -> google.protobuf.StringValue
	21, // 20: eventpb.Event.testingUint:type_name -> google.protobuf.UInt64Value
	22, // 21: eventpb.Event.tester:type_name -> testerpb.Tester
