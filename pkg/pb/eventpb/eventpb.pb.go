...
func (x *Deliver) GetCert() *availabilitypb.Cert {
	if x != nil {
		return x.Cert
	}
	return nil
...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x22, 0xfc, 0x10, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e,
	...
	0x62, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x72, 0x69,
	...
	0x41, 0x4c, 0x4c, 0x6f, 0x61, 0x64, 0x41, 0x6c, 0x6c, 0x22, 0x43, 0x0a, 0x07, 0x44, 0x65, 0x6c,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*contextstorepb.Origin)(nil),   // 43: contextstorepb.Origin
	(*isspb.ISSHashOrigin)(nil),     // 44: isspb.ISSHashOrigin
	(*dslpb.Origin)(nil),            // 45: dslpb.Origin
	(*isspb.ISSSignOrigin)(nil),     // 46: isspb.ISSSignOrigin
	(*isspb.ISSSigVerOrigin)(nil),   // 47: isspb.ISSSigVerOrigin
	(*messagepb.Message)(nil),       // 48: messagepb.Message
	(*availabilitypb.Cert)(nil),     // 49: availabilitypb.Cert
	(*commonpb.StateSnapshot)(nil),  // 50: commonpb.StateSnapshot
	(*commonpb.Membership)(nil),     // 51: commonpb.Membership
}
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	39, // 33: eventpb.Event.testingString:type_name -> google.protobuf.StringValue
	40, // 34: eventpb.Event.testingUint:type_name -> google.protobuf.UInt64Value
	0,  // 35: eventpb.Event.next:type_name -> eventpb.Event
	41, // 36: eventpb.NewRequests.requests:type_name -> requestpb.Request
	42, // 37: eventpb.HashRequest.data:type_name -> commonpb.HashData
	6,  // 38: eventpb.HashRequest.origin:type_name -> eventpb.HashOrigin
	6,  // 39: eventpb.HashResult.origin:type_name -> eventpb.HashOrigin
	43, // 40: eventpb.HashOrigin.context_store:type_name -> contextstorepb.Origin
	41, // 41: eventpb.HashOrigin.request:type_name -> requestpb.Request
	44, // 42: eventpb.HashOrigin.iss:type_name -> isspb.ISSHashOrigin
	45, // 43: eventpb.HashOrigin.dsl:type_name -> dslpb.Origin
	9,  // 44: eventpb.SignRequest.origin:type_name -> eventpb.SignOrigin
	9,  // 45: eventpb.SignResult.origin:type_name -> eventpb.SignOrigin
	43, // 46: eventpb.SignOrigin.context_store:type_name -> contextstorepb.Origin
	46, // 47: eventpb.SignOrigin.iss:type_name -> isspb.ISSSignOrigin
	45, // 48: eventpb.SignOrigin.dsl:type_name -> dslpb.Origin
	10, // 49: eventpb.VerifyNodeSigs.data:type_name -> eventpb.SigVerData
	13, // 50: eventpb.VerifyNodeSigs.origin:type_name -> eventpb.SigVerOrigin
	13, // 51: eventpb.NodeSigsVerified.origin:type_name -> eventpb.SigVerOrigin
	43, // 52: eventpb.SigVerOrigin.context_store:type_name -> contextstorepb.Origin
	47, // 53: eventpb.SigVerOrigin.iss:type_name -> isspb.ISSSigVerOrigin
	45, // 54: eventpb.SigVerOrigin.dsl:type_name -> dslpb.Origin
	41, // 55: eventpb.RequestReady.request:type_name -> requestpb.Request
	48, // 56: eventpb.SendMessage.msg:type_name -> messagepb.Message
	48, // 57: eventpb.MessageReceived.msg:type_name -> messagepb.Message
	0,  // 58: eventpb.WALAppend.event:type_name -> eventpb.Event
	0,  // 59: eventpb.WALEntry.event:type_name -> eventpb.Event
	49, // 60: eventpb.Deliver.cert:type_name -> availabilitypb.Cert
	41, // 61: eventpb.VerifyRequestSig.request:type_name -> requestpb.Request
	41, // 62: eventpb.RequestSigVerified.request:type_name -> requestpb.Request
	41, // 63: eventpb.StoreVerifiedRequest.request:type_name -> requestpb.Request
	43, // 64: eventpb.AppSnapshotRequest.origin:type_name -> contextstorepb.Origin
	43, // 65: eventpb.AppSnapshot.origin:type_name -> contextstorepb.Origin
	50, // 66: eventpb.AppRestoreState.snapshot:type_name -> commonpb.StateSnapshot
	0,  // 67: eventpb.TimerDelay.events:type_name -> eventpb.Event
	0,  // 68: eventpb.TimerRepeat.events:type_name -> eventpb.Event
	51, // 69: eventpb.NewConfig.membership:type_name -> commonpb.Membership
