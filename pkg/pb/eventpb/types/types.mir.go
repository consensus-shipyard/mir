...
import (
	...
	types17 "github.com/filecoin-project/mir/pkg/pb/granitepb/types"
...
func Event_TypeFromPb(pb eventpb.Event_Type) Event_Type {
	...
	case *eventpb.Event_Granite:
		return &Event_Granite{Granite: types17.EventFromPb(pb.Granite)}
...
type Event_Granite struct {
	Granite *types17.Event
}

func (*Event_Granite) isEvent_Type() {}

func (w *Event_Granite) Unwrap() *types17.Event {
	return w.Granite
}

func (w *Event_Granite) Pb() eventpb.Event_Type {
	if w == nil {
		return nil
	}
	if w.Granite == nil {
		return &eventpb.Event_Granite{}
	}
	return &eventpb.Event_Granite{Granite: (w.Granite).Pb()}
}

func (*Event_Granite) MirReflect() mirreflect.Type {
	return mirreflect.TypeImpl{PbType_: reflectutil.TypeOf[*eventpb.Event_Granite]()}
}
