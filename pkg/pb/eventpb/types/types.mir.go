...
import (
	...
	types11 "github.com/filecoin-project/mir/pkg/pb/commonpb/types"
	...
	types10 "github.com/filecoin-project/mir/pkg/pb/requestpb/types"
...
type NewRequests struct {
	Requests []*types10.Request
}

func NewRequestsFromPb(pb *eventpb.NewRequests) *NewRequests {
	return &NewRequests{
		Requests: types9.ConvertSlice(pb.Requests, func(t *requestpb.Request) *types10.Request {
			return types10.RequestFromPb(t)
		}),
	}
}
...
func (m *NewRequests) Pb() *eventpb.NewRequests {
	return &eventpb.NewRequests{
		Requests: types9.ConvertSlice(m.Requests, func(t *types10.Request) *requestpb.Request {
			return (t).Pb()
		}),
	}
}
...
type HashRequest struct {
	Data   []*types11.HashData
	Origin *HashOrigin
}

func HashRequestFromPb(pb *eventpb.HashRequest) *HashRequest {
	return &HashRequest{
		Data: types9.ConvertSlice(pb.Data, func(t *commonpb.HashData) *types11.HashData {
			return types11.HashDataFromPb(t)
		}),
...
func (m *HashRequest) Pb() *eventpb.HashRequest {
	return &eventpb.HashRequest{
		Data: types9.ConvertSlice(m.Data, func(t *types11.HashData) *commonpb.HashData {
			return (t).Pb()
		}),
		Origin: (m.Origin).Pb(),
	}
...
func HashOrigin_TypeFromPb(pb eventpb.HashOrigin_Type) HashOrigin_Type {
	...
	case *eventpb.HashOrigin_ContextStore:
		return &HashOrigin_ContextStore{ContextStore: types12.OriginFromPb(pb.ContextStore)}
	case *eventpb.HashOrigin_Request:
		return &HashOrigin_Request{Request: types10.RequestFromPb(pb.Request)}
	case *eventpb.HashOrigin_Iss:
		return &HashOrigin_Iss{Iss: pb.Iss}
	case *eventpb.HashOrigin_Dsl:
		return &HashOrigin_Dsl{Dsl: types13.OriginFromPb(pb.Dsl)}
	case *eventpb.HashOrigin_Checkpoint:
		return &HashOrigin_Checkpoint{Checkpoint: types8.HashOriginFromPb(pb.Checkpoint)}
...
func (w *HashOrigin_ContextStore) Unwrap() *types12.Origin {
...
type HashOrigin_Request struct {
	Request *types10.Request
}

func (*HashOrigin_Request) isHashOrigin_Type() {}

func (w *HashOrigin_Request) Unwrap() *types10.Request {
	return w.Request
}
...
func (w *HashOrigin_Dsl) Unwrap() *types13.Origin {
	return w.Dsl
}
...
type HashOrigin_Checkpoint struct {
	Checkpoint *types8.HashOrigin
}

func (*HashOrigin_Checkpoint) isHashOrigin_Type() {}

func (w *HashOrigin_Checkpoint) Unwrap() *types8.HashOrigin {
	return w.Checkpoint
}
...
type NewConfig struct {
	EpochNr    types.EpochNr
	Membership *types11.Membership
}

func NewConfigFromPb(pb *eventpb.NewConfig) *NewConfig {
	return &NewConfig{
		EpochNr:    (types.EpochNr)(pb.EpochNr),
		Membership: types11.MembershipFromPb(pb.Membership),
	}
}
