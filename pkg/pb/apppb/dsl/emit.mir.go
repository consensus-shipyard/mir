...
func NewEpoch(m dsl.Module, destModule types.ModuleID, epochNr types2.EpochNr, epochModule types.ModuleID) {
	dsl.EmitMirEvent(m, events.NewEpoch(destModule, epochNr, epochModule))
}
