...
type PBFTModule struct {
	...
	PvcId          string       `protobuf:"bytes,4,opt,name=pvc_id,json=pvcId,proto3" json:"pvc_id,omitempty"`
}
...
func (x *PBFTModule) GetPvcId() string {
	if x != nil {
		return x.PvcId
	}
	return ""
...
var file_ordererpb_ordererpb_proto_rawDesc = []byte{
	...
	0x3a, 0x04, 0x80, 0xa6, 0x1d, 0x01, 0x22, 0x9a, 0x01, 0x0a, 0x0a, 0x50, 0x42, 0x46, 0x54, 0x4d,
	...
	0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x15, 0x0a, 0x06, 0x70, 0x76, 0x63, 0x5f, 0x69, 0x64,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x76, 0x63, 0x49, 0x64, 0x3a, 0x04, 0x80,
