...
type PPrepValidator struct {
	...
	ValidityChecker uint64                `protobuf:"varint,1,opt,name=validity_checker,json=validityChecker,proto3" json:"validity_checker,omitempty"`
	Membership      *trantorpb.Membership `protobuf:"bytes,2,opt,name=membership,proto3" json:"membership,omitempty"`
}

func (x *PPrepValidator) Reset() {
	*x = PPrepValidator{}
	if protoimpl.UnsafeEnabled {
...
func (x *PPrepValidator) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PPrepValidator) ProtoMessage() {}

func (x *PPrepValidator) ProtoReflect() protoreflect.Message {
	mi := &file_ordererpb_pprepvalidatorpb_pprepvalidatorpb_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PPrepValidator.ProtoReflect.Descriptor instead.
func (*PPrepValidator) Descriptor() ([]byte, []int) {
	return file_ordererpb_pprepvalidatorpb_pprepvalidatorpb_proto_rawDescGZIP(), []int{4}
}

func (x *PPrepValidator) GetValidityChecker() uint64 {
	if x != nil {
...
func (x *PPrepValidator) GetMembership() *trantorpb.Membership {
	if x != nil {
		return x.Membership
	}
	return nil
...
var file_ordererpb_pprepvalidatorpb_pprepvalidatorpb_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x70, 0x62, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x70, 0x72,
	...
	0x70, 0x72, 0x65, 0x70, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x01, 0x0a, 0x12, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x70, 0x72, 0x65, 0x70, 0x72,
	...
	0x67, 0x69, 0x6e, 0x3a, 0x04, 0x98, 0xa6, 0x1d, 0x01, 0x22, 0x86, 0x01, 0x0a, 0x13, 0x70, 0x72,
	...
	,
	...
	0x2f, 0x70, 0x62, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x65, 0x72, 0x70, 0x62, 0x2f, 0x70, 0x70,
	0x72, 0x65, 0x70, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x70, 0x62, 0x62, 0x06,
...
var file_ordererpb_pprepvalidatorpb_pprepvalidatorpb_proto_goTypes = []interface{}{
	...
	(*PPrepValidator)(nil),           // 4: pprepvalidatorpb.PPrepValidator
...
var file_ordererpb_pprepvalidatorpb_pprepvalidatorpb_proto_depIdxs = []int32{
	...
	8, // 7: pprepvalidatorpb.PPrepValidator.membership:type_name -> trantorpb.Membership
