...
type PPrepValidator struct {
	...
	PpvType    uint64                `protobuf:"varint,1,opt,name=ppv_type,json=ppvType,proto3" json:"ppv_type,omitempty"`
...
func (x *PPrepValidator) GetPpvType() uint64 {
	if x != nil {
		return x.PpvType
	}
	return 0
...
var file_ordererpb_pprepvalidatorpb_pprepvalidatorpb_proto_rawDesc = []byte{
	...
	0x68, 0x0a, 0x0e, 0x50, 0x50, 0x72, 0x65, 0x70, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x70, 0x76, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x07, 0x70, 0x70, 0x76, 0x54, 0x79, 0x70, 0x65, 0x12, 0x35, 0x0a, 0x0a,
