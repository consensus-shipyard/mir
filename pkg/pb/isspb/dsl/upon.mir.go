...
func UponSBDeliver(m dsl.Module, handler func(sn types2.SeqNr, data []uint8, aborted bool, leader stdtypes.NodeID, instanceId stdtypes.ModuleID) error) {
...
func UponDeliverCert(m dsl.Module, handler func(sn types2.SeqNr, cert *types3.Cert, empty bool) error) {
