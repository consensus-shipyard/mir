...
var file_isspb_isspb_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x6e, 0x74, 0x22, 0xd4, 0x0a, 0x0a, 0x0f, 0x53, 0x42, 0x49, 0x6e, 0x73, 0x74, 0x61,
	...
	0x74, 0x63, 0x68, 0x52, 0x65, 0x61, 0x64, 0x79, 0x12, 0x33, 0x0a, 0x0a, 0x63, 0x65, 0x72, 0x74,
	0x5f, 0x72, 0x65, 0x61, 0x64, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x69,
	0x73, 0x73, 0x70, 0x62, 0x2e, 0x53, 0x42, 0x43, 0x65, 0x72, 0x74, 0x52, 0x65, 0x61, 0x64, 0x79,
	0x48, 0x00, 0x52, 0x09, 0x63, 0x65, 0x72, 0x74, 0x52, 0x65, 0x61, 0x64, 0x79, 0x12, 0x39, 0x0a,
...
var file_isspb_isspb_proto_depIdxs = []int32{
	...
	45, // 44: isspb.SBInstanceEvent.resurrect_batch:type_name -> requestpb.Batch
	36, // 45: isspb.SBInstanceEvent.pbft_persist_preprepare:type_name -> isspbftpb.Preprepare
	37, // 46: isspb.SBInstanceEvent.pbft_persist_prepare:type_name -> isspbftpb.Prepare
	38, // 47: isspb.SBInstanceEvent.pbft_persist_commit:type_name -> isspbftpb.Commit
	39, // 48: isspb.SBInstanceEvent.pbft_persist_signed_view_change:type_name -> isspbftpb.SignedViewChange
	41, // 49: isspb.SBInstanceEvent.pbft_persist_new_view:type_name -> isspbftpb.NewView
	46, // 50: isspb.SBInstanceEvent.pbft_view_change_batch_timeout:type_name -> isspbftpb.VCBatchTimeout
	45, // 51: isspb.SBBatchReady.batch:type_name -> requestpb.Batch
	47, // 52: isspb.SBCertReady.cert:type_name -> availabilitypb.Cert
	4,  // 53: isspb.SBMessageReceived.msg:type_name -> isspb.SBInstanceMessage
	48, // 54: isspb.SBHashRequest.data:type_name -> commonpb.HashData
	26, // 55: isspb.SBHashRequest.origin:type_name -> isspb.SBHashOrigin
	27, // 56: isspb.SBHashResult.origin:type_name -> isspb.SBInstanceHashOrigin
	27, // 57: isspb.SBHashOrigin.origin:type_name -> isspb.SBInstanceHashOrigin
	36, // 58: isspb.SBInstanceHashOrigin.pbft_preprepare:type_name -> isspbftpb.Preprepare
	36, // 59: isspb.SBInstanceHashOrigin.pbft_missing_preprepare:type_name -> isspbftpb.Preprepare
	41, // 60: isspb.SBInstanceHashOrigin.pbft_new_view:type_name -> isspbftpb.NewView
	36, // 61: isspb.SBInstanceHashOrigin.pbft_catch_up_response:type_name -> isspbftpb.Preprepare
	30, // 62: isspb.SBSignResult.origin:type_name -> isspb.SBInstanceSignOrigin
	30, // 63: isspb.SBSignOrigin.origin:type_name -> isspb.SBInstanceSignOrigin
	49, // 64: isspb.SBInstanceSignOrigin.pbft_view_change:type_name -> isspbftpb.ViewChange
	33, // 65: isspb.SBNodeSigsVerified.origin:type_name -> isspb.SBInstanceSigVerOrigin
	33, // 66: isspb.SBSigVerOrigin.origin:type_name -> isspb.SBInstanceSigVerOrigin
	39, // 67: isspb.SBInstanceSigVerOrigin.pbft_signed_view_change:type_name -> isspbftpb.SignedViewChange
	41, // 68: isspb.SBInstanceSigVerOrigin.pbft_new_view:type_name -> isspbftpb.NewView
