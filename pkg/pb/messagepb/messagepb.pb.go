...
func (x *Message) GetGranite() *granitepb.Message {
	if x, ok := x.GetType().(*Message_Granite); ok {
		return x.Granite
	}
	return nil
}
...
type Message_Granite struct {
	Granite *granitepb.Message `protobuf:"bytes,8,opt,name=granite,proto3,oneof"`
}
...
var file_messagepb_messagepb_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdd,
	0x03, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x57, 0x0a, 0x0b, 0x64, 0x65,
	...
	0x00, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x07, 0x67, 0x72,
	0x61, 0x6e, 0x69, 0x74, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x72,
	0x61, 0x6e, 0x69, 0x74, 0x65, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48,
	0x00, 0x52, 0x07, 0x67, 0x72, 0x61, 0x6e, 0x69, 0x74, 0x65, 0x3a, 0x04, 0xc0, 0xe4, 0x1d, 0x01,
...
var file_messagepb_messagepb_proto_goTypes = []interface{}{
	...
	(*granitepb.Message)(nil),    // 7: granitepb.Message
}
var file_messagepb_messagepb_proto_depIdxs = []int32{
	...
	7, // 6: messagepb.Message.granite:type_name -> granitepb.Message
