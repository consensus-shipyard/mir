...
// GenericImpl represents a generic implementation of the Crypto module that can be used at Node instantiation
...
// NewGenericImpl returns a new initialized instance of a Crypto implementation.
...
func NewGenericImpl(privKey []byte) (*GenericImpl, error) {
...
func (c *GenericImpl) Sign(data [][]byte) ([]byte, error) {
...
func (c *GenericImpl) RegisterNodeKey(pubKey []byte, nodeID t.NodeID) error {
...
// Returns nil on success, a non-nil error on failure.
func (c *GenericImpl) RegisterClientKey(pubKey []byte, clientID t.ClientID) error {
...
func (c *GenericImpl) DeleteNodeKey(nodeID t.NodeID) {
...
func (c *GenericImpl) DeleteClientKey(clientID t.ClientID) {
...
func (c *GenericImpl) VerifyNodeSig(data [][]byte, signature []byte, nodeID t.NodeID) error {
...
func (c *GenericImpl) VerifyClientSig(data [][]byte, signature []byte, clientID t.ClientID) error {
...
func (c *GenericImpl) verifySig(data [][]byte, signature []byte, pubKey interface{}) error {
...
// and the pub key can be passed to GenericImpl.RegisterNodeKey.
...
// The output of this function can be used with GenericImpl.RegisterClientKey and GenericImpl.RegisterNodeKey.
...
// The output of this function can be passed to New when creating an instance of GenericImpl.
...
// that can be used directly with GenericImpl.RegisterNodeKey or GenericImpl.RegisterClientKey.
