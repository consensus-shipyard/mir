...
func NewDummyHostWithPrivKey(listenAddr stdtypes.NodeAddress, privKey libp2pcrypto.PrivKey) (host.Host, error) {
...
func NewDummyHost(numericID int, sourceAddr stdtypes.NodeAddress) host.Host {
...
func NewDummyHostNoListen(numericID int, _ stdtypes.NodeAddress) host.Host {
	// sourceMultiAddr, priv := NewDummyHostID(id, basePort)
...
func NewDummyMultiaddr(numericID int, sourceAddr stdtypes.NodeAddress) multiaddr.Multiaddr {
