...
// Source: github.com/filecoin-project/mir/pkg/modules/mockmodules/internal (interfaces: ModuleImpl)
...
func (m *MockModuleImpl) Event(arg0 *eventpb.Event) (*events.EventList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockModuleImplMockRecorder) Event(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Event", reflect.TypeOf((*MockModuleImpl)(nil).Event), arg0)
}
