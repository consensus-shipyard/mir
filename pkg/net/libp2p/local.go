...
func NewLocalLibp2pTransport(nodeIDs []t.NodeID, logger logging.Logger, port int) *LocalLibp2pTransport {
	...
	for i, id := range nodeIDs {
		...
		lt.membership[id] = t.NodeAddress(tools.NewDummyMultiaddr(i, hostAddr))
	}

	return lt
}

func (t *LocalLibp2pTransport) Link(sourceID t.NodeID) (*Transport, error) {
